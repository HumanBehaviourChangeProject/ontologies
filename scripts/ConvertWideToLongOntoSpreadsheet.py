...
prjdir = '/Users/hastingj/Work/Onto/HBCP/ontologies/BehaviourChangeTechniques/'

os.chdir(prjdir)

file_name = "BCTO_Wide.xlsx"

id_root = 7001 # BCI content is BCIO:007000
...
wb_out.save("BCTO-converted.xlsx")
