...
#python3 ./ExcelToOwl.py -d bcio_upper_level.owl,bcio_external.owl -i ../Setting/inputs/Setting.xlsx -o ../Setting/bcio_setting.owl
python3 ./ExcelToOwl.py -d bcio_upper_level.owl,bcio_external.owl -i ../ModeOfDelivery/inputs/MoD.xlsx -o ../ModeOfDelivery/bcio_mode_of_delivery.owl
