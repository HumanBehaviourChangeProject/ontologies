...
# Overview of Files
* **BCIO-setting-hierarchy.xlsx:** A spreadsheet with the Intervention Setting Ontology classes organised hierarchically for applications in behavioural sciences.
* **bcio_setting.owl:** The Intervention Setting Ontology classes and their relations in OWL format.
* **bcio_setting.xlsx:** A spreadsheet with the Intervention Setting Ontology classes and their relations.


# Instructions for Downloading and Accessing Ontology Files

There are three ways to download and view the Intervention Setting Ontology:

# Method 1: Viewing the ontology in a simple spreadsheet format
1.	Download the file bcio_setting.xlsx.
...
1.	Download the file BCIO-setting-hierarchy.xlsx.
...
2.	Download the file bcio_setting.owl and open it in Protégé.
3.	Note: When uploading this file, you may be prompted to resolve dependencies (e.g., bcio_upper_level.owl). These can be downloaded from the repository (see the file “Upper-level BCIO”) and uploaded to Protégé as needed.
...
# Relevant resources
Table version of **Intervention Setting Ontology in the published paper** can be found here: https://osf.io/g8qfv/. Please note that this version will not be maintained but can be used as reference.

**Intervention Setting Ontology coding guidelines:** https://osf.io/h4sdy/files/76jty
